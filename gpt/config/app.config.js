...
export const validateApiKeys = () => {
  const patterns = {
    REACT_APP_OPENAI_API_KEY: /^sk-[a-zA-Z0-9-]{40,}$/,
    REACT_APP_PERPLEXITY_API_KEY: /^pplx-[a-zA-Z0-9]{32,}$/,
    REACT_APP_WEATHER_API_KEY: /^[a-zA-Z0-9]{16,}$/,
    REACT_APP_KAKAO_API_KEY: /^[a-zA-Z0-9]{32}$/
  };
